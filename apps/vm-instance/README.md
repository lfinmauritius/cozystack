...
| `disks[i].hotpluggable` | Allow attaching and detaching the disk while the VM is running. Requires the DeclarativeHotplugVolumes feature gate on the cluster, and bus to be "scsi" or "virtio".                                         | `bool`     | `false`     |
